  ...
  case $opt in
    o)
      ...
      if [ $arg_o = "webp" ]; then
        ...
        sleep 1
        find $WWW/content/images/. -newer $WWW/content/images/optimg-avif.flag -type f -regex ".*\.\($JPG\|$JPEG\|$PNG\)" -exec mogrify -format avif -depth 10 -background white -alpha remove -alpha off -define heic:speed=8 {}  \; -print
