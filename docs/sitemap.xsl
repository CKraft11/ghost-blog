        ...
        <html xmlns="https://www.w3.org/1999/xhtml">
            ...
            <body>
                <div id="content">
                    <h1>XML Sitemap</h1>
                    <p class="desc">
                        This is a sitemap generated by <a href="httpss://ghost.org">Ghost</a> to allow search engines to discover this blog's content.
                    </p>
                    ...
                    <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
                        <p class="desc"><a href="https://debug.cadenkraft.com/sitemap.xml" class="back-link">&#8592; Back to index</a></p>
                        <table id="sitemap" cellpadding="3">
                            <thead>
                                <tr>
